...
public class ValidationMessages {
	...
	public static final String CONSTRUCTOR_ASSIGNMENT_CANNOT_CONTAIN_REPOSITORY_OPERATION = "Constructor assignment cannot contain repository operation %s.";
	public static final String OPERATION_ARGUMENTS_CANNOT_CONTAIN_REPOSITORY_OPERATION = "Operation arguments cannot contain repository operation %s.";
	...
	public static final String REPOSITORY_OPERATION_DOES_NOT_HAVE_ASSOCIATED_REPOSITORY = "Repository operation %s does not have associated repository.";
	public static final String REPOSITORY_OPERATION_IS_NOT_DEFINED = "Repository operation %s is not defined in the repository.";
	public static final String NUMBER_QUERY_ARGUMENTS_ARE_NOT_CONSISTENT = "Number of repository %s arguments are not consistent with parameters definition.";
	public static final String REPOSITORY_OPERATION_ARGUMENT_IS_NOT_DECLARED = "Repository operation argument %s is not declared.";
	public static final String REPOSITORY_OPERATION_ARGUMENT_TYPE_DOES_NOT_MATCH = "Repository operation argument type %s does not match repository operation parameter type.";
	public static final String REPOSITORY_OPERATION_DOES_NOT_RETURN_ENTITY = "Repository operation %s does not return entity.";
	public static final String REPOSITORY_OPERATION_RETURNED_ENTITY_DOES_NOT_BELONG_TO_AGGREGATE = "Repository operation returned entity %s does not belong to mapped aggregate.";
	...
	public static final String CONSTRUCTOR_COMMAND_CANNOT_CONTAIN_ROOT = "Constructor command cannot contain root.";
	public static final String THIS_ONLY_ALLOWED_IN_CONSTRUCTOR_COMMAND = "this only allowed in constructor command.";
	...
	public static final String CONSTRUCTOR_COMMNAD_ASSIGNMENT_EXPRESSION_TYPE_ERROR = "Constructor command assigment expression should be of type %s.";
	public static final String CONSTRUCTOR_COMMAND_SHOULD_BE_ASSIGNMENT = "Constructor command should be assignment.";
	public static final String DOMAIN_OBJECT_OPERATION_PARAMETER_TYPE_ERROR = "Domain object operation parameter constructor should be simple type or aggregate entities type.";
	public static final String DOMAIN_OBJECT_OPERATION_PARAMETERS_REQUIRE_AGGREGATE_ROOT = "Domain object operation constructor parameters require root aggregate.";
	public static final String DOMAIN_OBJECT_OPERATION_CONSTRUCTOR_ASSIGNMENTS_SHOULD_MAP_KEY_ATTRIBUTE = "Domain object operation constructor assignements should map the key attribute %s of the aggregate root entity.";
	public static final String DOMAIN_OBJECT_OPERATION_CONSTRUCTOR_COMMAND = "Domain object operation constructor command can only be assignment.";
	public static final String DOMAIN_OBJECT_OPERATION_CONSTRUCTOR_ASSIGMENT_COMMAND_LEFT_PATH_EXPRESSION_SHOULD_USE_THIS = "Domain object operation constructor assignment command left element should use this.";
